...
eachLine(filename, function(line) {
  ...
  switch(letters[0]) {
    case 'A':
      switch(letters[1]) {
        case 'X': winScore = 3 + 1; break;
        case 'Y': winScore = 6 + 2; break;
        case 'Z': winScore = 0 + 3; break;
    ...
    case 'C':
      switch(letters[1]) {
        case 'X': winScore = 6 + 1; break;
        case 'Y': winScore = 0 + 2; break;
        case 'Z': winScore = 3 + 3; break;
        default: console.log("Also bad!"); break;
      }
      break;
    default:
